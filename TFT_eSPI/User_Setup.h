...
#define TFT_CS   30  // Chip select control pin D8
#define TFT_DC   28  // Data Command control pin
#define TFT_RST  29  // Reset pin (could connect to NodeMCU RST, see next line)
...
//#define SPI_FREQUENCY  27000000 // this works
